...
import com.business.victorehansone.databinding.ActivitySignupBinding;
...
//        }
    ...
    private void registration(String FirstName, String Password) {
        ...
        String url = Apis.ROOT_URLL + getString(R.string.register_ic_user) + "ic_username=" + FirstName + "&password=" + Password;
        Log.e("Url------->", url);
