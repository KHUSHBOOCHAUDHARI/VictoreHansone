...
import com.business.victorehansone.Activity.ScanBarCodeActivity;
import com.business.victorehansone.Activity.TermandCondition;
...
import com.business.victorehansone.databinding.SendFragmentBinding;
...
public class SendFragment  extends Fragment {
    ...
    public void SendCurrency(String ic_userId, String address, String amount) {
        binding.progressBar.setVisibility(View.VISIBLE);
        AsyncHttpClient client = new AsyncHttpClient();
        String url = Apis.ROOT_URLL + getString(R.string.withdrow_api)+"ic_userId="+ic_userId+"&to="+address+"&amount="+amount;
        Log.e("Url------->", url);
