...
import com.business.cryptosoar.databinding.ActivityEditProfileBinding;
    ...
    public void form() {
        ...
        if ( FirstName.isEmpty() || FirstName.equalsIgnoreCase("")) {
            ...
            if (method.isNetworkAvailable(EditProfile.this)) {
                ...
                registration(method.pref.getString(method.Id,null),FirstName,LastName);
            } else {
                method.alertBox(getResources().getString(R.string.internet_connection));
            }
        }
    }
    private void registration(String user_id,String FirstName, String LastName){
