...
import com.business.cryptosoar.Activity.DetailActivity;
...
public class TransactionHistoryByFundAdapter extends RecyclerView.Adapter<TransactionHistoryByFundAdapter.ViewHolder>{
    ...
    public TransactionHistoryByFundAdapter(Activity activity, List<TransactionModel> listdata) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
         ...
         TextView title,totalamount_lable,totalamount_txt,date_txt,date_lable,status,plane_txt;
